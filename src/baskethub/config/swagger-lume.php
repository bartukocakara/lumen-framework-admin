...
return [
    ...
    'paths' => [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        'base' => env('http://localhost:8081/docs', null),
    ...
    */
    ...
    'validator_url' => null,
    'url_to_docs' => env("L5_SWAGGER_BASE_PATH"),
     ...
     */
    'constants' => [
        'SWAGGER_LUME_CONST_HOST' => env('SWAGGER_LUME_CONST_HOST', 'http://localhost:8081/docs'),
    ],
];
